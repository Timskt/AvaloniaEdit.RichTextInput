...
```xml
<PackageReference Include="AvaloniaEdit.RichTextInput" Version="11.3.0-rich.1" />
```

TextMate syntax highlighting:

```xml
<PackageReference Include="AvaloniaEdit.RichTextInput.TextMate" Version="11.3.0-rich.1" />
